...
def dashboard():
    ...
    if 'user' in session:
        ...
        login_mobile="123456789"
        login_address="sarjapur"
        ...
        return render_template('dashboard.html', first=first_name,login=login_name,login_email=login_email,login_mobile=login_mobile,login_phone=login_phone,login_address=login_address)
